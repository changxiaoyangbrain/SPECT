...
def main():
    ...
    my_recon = loader.load_volume(os.path.join(base_dir, "MyRecon.dat"))
    ref_recon = loader.load_volume(os.path.join(base_dir, "OSEMReconed.dat"))
    
    my_filt = loader.load_volume(os.path.join(base_dir, "MyFiltered.dat"))
    ref_filt = loader.load_volume(os.path.join(base_dir, "Filtered.dat"))
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(base_dir, "viz_ortho_views.png"))
    plt.close()
    print("Saved orthogonal views to viz_ortho_views.png")
